...
// and having as a subject something like "Your DaDaBIK 11.12 Elba ENTERPRISE File Download"
...
// by default (use_long_select_query_for_count = 1), DaDaBIK uses, to count the number of results of a quick or advanced search, the same query used to show the results, i.e. also joining other tables (if you have lookup fields). If you set this parameter to 0, a simple SELECT COUNT(*) is used for the first part of the query, instead. This increases the performances and we recommend to set this parameter to 0 unless you are experiencing issues. This will soon become 0 by default.
$use_long_select_query_for_count = 1;
