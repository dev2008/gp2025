...
$_cp_sql="INSERT INTO `g_turnsummary` 
				(`turn_id`, `game`, `league`, `season`, `week`, `coach`, `mytimestamp`, `processed`, `roundup`,`uploadID`) 
			VALUES 
				(NULL, '$_cdp_type', '$_cp_league', '$_cp_season', '$_cp_week', '$_cp_mycoachname', current_timestamp(), '1', '$roundup',$_cp_myid);";
