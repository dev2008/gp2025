...
<?php } ?>
<?php } else{ ?>
<link rel="stylesheet" href="css/styles_screen_old_12.6.css<?php if ( $force_reload_css_js === 1){ echo '?v='.rand(1,10000);} ?>" type="text/css" media="screen">
<?php } ?>
...
<script language="javascript" type="text/javascript" src="include/tinymce_6.8.3/tinymce.min.js"></script>

<script src="include/tagify_4.33.2/tagify.js"></script>
<script src="include/tagify_4.33.2/tagify.polyfills.min.js"></script>
<link href="include/tagify_4.33.2/tagify.css" rel="stylesheet" type="text/css" />
...
<script src="include/Sortable_1.15.3.min.js"></script>
<?php } ?>
...
<script src="include/general_functions_12.7.js"></script>
...
<?php if ($orazio_edition === 1){
    ...
    echo '<td >&nbsp;&nbsp;&nbsp;<a title="Exit the DEV Area and view the app you are building" class="bottom_menu_active"  style="color:red;font-size:24px;"  href="index.php">&nbsp;&nbsp;VIEW this app&nbsp;&nbsp;</a></td>';
} ?>
