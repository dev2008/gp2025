...
// and having as a subject something like "Your DaDaBIK 12.7 Aveto Enterprise Delivery Information"
...
// by default DaDaBIK creates an administrator user (username: root, password: your chosen password) and a normal user (username: alfonso, password: your chosen password).
...
$allowed_field_types_omnisearch = ['text','textarea','rich_editor','select_single','select_single_radio','select_multiple_menu','select_multiple_checkbox','id_user', 'generic_file','image_file','camera','date','date_time','insert_date_time','update_date_time'];
...
$dadabik_config_version = '12.7';
$dadabik_config_codename = 'Aveto';