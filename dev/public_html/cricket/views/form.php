			...
			switch ($fields_labels_ar[$i]["type_field"]){
                ...
                <td valign="top" >
					...
					$form.= ' id="" data-uploader-input type="file" style="display:none">
                        ...
                        <progress data-uploader-progress-bar id="progress-bar" style="width: 100%; height:10px;display:none" max=100 value=0 ></progress>
                        <div class="uploader_result" id="uploader_result" style="display:none"  data-uploader-result></div>
                    </div>
                </template>';
           }
